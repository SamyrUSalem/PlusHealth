	...
	if(Now == 0 || Now == 4)  {
		...
		function prazoSocilitacao() {
			...
			if (dataAtual > dataInicial) {
				throw("Data de Inicio do Evento deve ser de pelo menos 20 dias")
				/* antes 60 dias */
			} else{
		...
		function prazoSolicitacao2() {
			...
			if (datinha > newDatinhaAtual) {
				throw("Data de Entrega para uma Jornada Completa deve ser de pelo menos 10 dias")
				/* antes 45 dias */
			} else{
				console.log("parabéns, seu evento foi programado com sucessagem garantida, meu nobre")
			}
		...
		function prazoSolicitacao3() {
			...
			if (dataAtualizada2 > dataInicializada2) {
				throw("Data de Entrega de uma Landing Page deve ser de pelo menos 10 dias")
				/* antes 30 dias */
			} else{
				console.log("parabéns, seu evento foi programado com sucessagem garantida, meu nobre")
			}
		...
		function prazoSolicitacao4() {
			...
			if (dataAtualizada3 > dataInicializada3) {
				throw("Data para executar a solicitação deve ser de pelo menos 5 dias")
				/* antes 20 dias */
			} else{
				console.log("parabéns, seu evento foi programado com sucessagem garantida, meu nobre")
			}
		...
		function prazoSolicitacao5() {
			...
			if (dataAtualizada4 > dataInicializada4) {
				throw("Data Mínima para preparar essas atividades é de 2 Dias")
				/* antes 10 dias */
			} else{
				console.log("parabéns, seu evento foi programado com sucessagem garantida, meu nobre")
			}
