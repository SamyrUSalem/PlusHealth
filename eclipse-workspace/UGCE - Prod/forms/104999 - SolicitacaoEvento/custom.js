...
$(document).ready(function() {
    var checkboxes = ["Eventos", "Coffee", "Jornada", "Logo", "Estrategia", "Imprensa", "Grafica", "Cobertura", "Outros"];
    var campos = ["eventos", "coffee", "jornada", "logo", "estrategia", "imprensa", "grafica", "cobertura", "outros"];

    checkboxes.forEach(function(checkboxId, index) {
        $('#' + checkboxId).change(function() {
            if (this.checked) {
                $('#' + campos[index]).collapse('show');
                $('a[href="#' + campos[index] + '"]').parent().collapse('show');
            } else {
                $('#' + campos[index]).collapse('hide');
                $('a[href="#' + campos[index] + '"]').parent().collapse('hide');
            }
        }).change();
    });
});
